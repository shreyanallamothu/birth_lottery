...
<h2>The Process</h2>
<p>I used data from the World Bank API, including GDP per capita, life expectancy at birth, child mortality rate, gini index, and access to water. One of the biggest challenges was dealing with inconsistent data coverage across countries and years. Many smaller nations had missing or incomplete data, which required careful handling and fallback logic.

Working with complex JSON structures and cleaning real-world data turned into a great exercise in patience and problem-solving.</p>

<p align="center">
 <img src="birth_lottery/Screenshots/birth_lottery_demo.gif" width="400">
</p>
